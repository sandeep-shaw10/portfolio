    ...
    render() {
        ...
        return (
            <>
                ...
                <div className = "row">
                    <form action="https://formspree.io/f/xdoyzegq" method="POST" onSubmit={this.submitForm} >
                        <h2 className = "mt-3" style={{color: this.props.themeColor}}>GET IN TOUCH</h2>
                        ...
                        <div className = "col-12">
                            <div className = "form-group mb-2">
                                <textarea value={this.state.values.message} name="message" className = "form-control" id="exampleFormControlTextarea1" placeholder="Enter Message" rows="5" required onChange={this.handleInputChange}></textarea>
                            </div>
                        </div>
                        <div className = "col-12">
                            <button className = "btn btn-light" onClick={this.sendMail} disabled={this.state.isSubmitting}>{(! this.state.isSubmitting)?"Send": "Wait " + fname}</button>
                        </div>
                    </form> 
